...
<html lang="en">
<head>
    @include('layouts.files.init.head')
</head>
<body>
<!-- Preloader -->
@include('layouts.files.includes.parsers.pre-loader')
<!-- ./ Preloader -->

<!-- Layout wrapper -->
<div class="layout-wrapper">
    <!-- Header -->
    @include('layouts.files.includes.overalls.header')
    <!-- ./ Header -->

    <!-- Content wrapper -->
    <div class="content-wrapper">
        <!-- begin::navigation -->
        @include('layouts.files.includes.overalls.navigation')
        <!-- end::navigation -->
        ...
        <div class="content-body">
            ...
            <div class="content">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-2 col-md-3">
                                <figure>
                                    <img class="img-fluid" src="{{ asset('file-manager/assets/media/svg/upgrade.svg') }}" alt="upgrade">
                                </figure>
                            </div>
                            ...
                            <div class="card-body text-center">
                                <div class="row mb-4">
                                    <div class="col-md-8 offset-md-2">
                                        <img src="{{ asset('file-manager/assets/media/svg/report.svg') }}" class="img-fluid" alt="report">
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        <div class="avatar-group">
                                            <figure class="avatar avatar-sm" data-toggle="tooltip" title="Baxie Roseblade">
                                                <img src="{{ asset('file-manager/assets/media/image/user/man_avatar5.jpg') }}" class="rounded-circle"
                                                     alt="image">
                                            </figure>
                                            <figure class="avatar avatar-sm" data-toggle="tooltip" title="Mella Mixter">
                                                <img src="{{ asset('file-manager/assets/media/image/user/women_avatar1.jpg') }}" class="rounded-circle"
                                                     alt="image">
                                            </figure>
                                            <figure class="avatar avatar-sm" data-toggle="tooltip" title="Jo Hugill">
                                                <img src="{{ asset('file-manager/assets/media/image/user/man_avatar1.jpg') }}" class="rounded-circle"
                                                     alt="image">
                                            </figure>
                                ...
                                <td>
                                    <div class="avatar-group">
                                        <figure class="avatar avatar-sm" title="Lisle Essam"
                                                data-toggle="tooltip">
                                            <img src="{{ asset('file-manager/assets/media/image/user/women_avatar2.jpg') }}"
                                                 class="rounded-circle"
                                                 alt="image">
                                        </figure>
                                        <figure class="avatar avatar-sm" title="Baxie Roseblade"
                                                data-toggle="tooltip">
                                            <img src="{{ asset('file-manager/assets/media/image/user/man_avatar5.jpg') }}"
                                                 class="rounded-circle"
                                                 alt="image">
                                        </figure>
                                    </div>
                                ...
                                <td>
                                    <div class="avatar-group">
                                        ...
                                        <figure class="avatar avatar-sm" title="Mella Mixter"
                                                data-toggle="tooltip">
                                            <img src="{{ asset('file-manager/assets/media/image/user/women_avatar1.jpg') }}"
                                                 class="rounded-circle"
                                                 alt="image">
                                        </figure>
                                        <figure class="avatar avatar-sm" title="Jo Hugill"
                                                data-toggle="tooltip">
                                            <img src="{{ asset('file-manager/assets/media/image/user/man_avatar1.jpg') }}"
                                                 class="rounded-circle"
                                                 alt="image">
                                        </figure>
                                        <figure class="avatar avatar-sm" title="Cullie Philcott"
                                                data-toggle="tooltip">
                                            <img src="{{ asset('file-manager/assets/media/image/user/women_avatar5.jpg') }}"
                                                 class="rounded-circle"
                                                 alt="image">
                                        </figure>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-group">
                                        ...
                                        <figure class="avatar avatar-sm" title="Mella Mixter"
                                                data-toggle="tooltip">
                                            <img src="{{ asset('file-manager/assets/media/image/user/women_avatar4.jpg') }}"
                                                 class="rounded-circle"
                                                 alt="image">
                                        </figure>
                                    </div>
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-item">
                        <div>
                            <figure class="avatar mr-3">
                                <img src="{{ asset('file-manager/assets/media/image/user/women_avatar5.jpg') }}" class="rounded-circle" alt="avatar">
                            </figure>
                        </div>
                        <div>
                            <h6 class="d-md-flex justify-content-between mb-3">
                        ...
                        <a href="#" class="link-1">Cullie Philcott</a> uploaded a picture
                            ...
                            <div class="row row-xs">
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sx-6">
                                    <figure>
                                        <img src="{{ asset('file-manager/assets/media/image/portfolio-five.jpg') }}"
                                             class="w-100 border-radius-1" alt="image">
                                    </figure>
                                </div>
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sx-6">
                                    <figure>
                                        <img src="{{ asset('file-manager/assets/media/image/portfolio-one.jpg') }}"
                                             class="w-100 border-radius-1" alt="image">
                                    </figure>
                                </div>
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sx-6">
                                    <figure>
                                        <img src="{{ asset('file-manager/assets/media/image/portfolio-three.jpg') }}"
                                             class="w-100 border-radius-1" alt="image">
                                    </figure>
                                </div>
                            </div>
            ...
            <!-- Footer -->
            @include('layouts.files.includes.overalls.footer')
            <!-- ./ Footer -->
        </div>
        <!-- ./ Content body -->

        <!-- Sidebar group -->
        @include('layouts.files.includes.overalls.sidebar')
        <!-- ./ Sidebar group -->
    </div>
    <!-- ./ Content wrapper -->
</div>
...
@include('layouts.files.init.scripts')
</body>
</html>
