...
<!-- Head -->
<head>
    @include('layouts.social-real.init.head')
    <style>
        /* Lock overlay */
        .lock-overlay {
            position: fixed;
...
<div class="layout overflow-hidden">
    <!-- Navigation -->
    @include('layouts.social-real.includes.overalls.navigation')
    <!-- Navigation -->

    <!-- Sidebar -->
    @include('layouts.social-real.includes.overalls.sidebar')
    <!-- Sidebar -->
...
@include('layouts.social-real.includes.gadgets.modals')

@include('layouts.social-real.init.scripts')

@if(session('usrNameNotSetYet') == 1)
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            Swal.fire({
                title: 'Set Your Username',
                text: 'You must set a username in order to continue.',
                input: 'text',
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = "POST";
                    form.action = "{{ route('set.username') }}";
...
@if(session('usrNameJustSet'))
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            Swal.fire({
                icon: 'success',
                title: 'Username saved!',
                text: 'Your username has been set successfully.',
                timer: 2000,
