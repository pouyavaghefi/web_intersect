                                    ...
                                    <li>
                                        <a href="#"
                                           class="list-group-item d-flex hide-show-toggler">
                                            <div>
                                                <figure class="avatar mr-3">
                                                    <img src="{{ asset('file-manager/assets/media/image/user/man_avatar4.jpg') }}"
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link profile-nav-link dropdown-toggle" title="User menu"
                           data-toggle="dropdown">
                            ...
                            <figure class="avatar avatar-sm">
                                <img src="{{ asset('file-manager/assets/media/image/user/man_avatar3.jpg') }}"
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                            <div class="text-center py-4"
                                 data-background-image="{{ asset('file-manager/assets/media/image/image1.jpg') }}">
